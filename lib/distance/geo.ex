defmodule Distance.Geo do
  ...
  defp do_distance(%Geo.Polygon{} = a, %Geo.MultiLineString{} = b), do: do_distance(b, a)

  defp do_distance(%Geo.MultiLineString{coordinates: strings_a}, %Geo.Polygon{
         coordinates: rings_b
       }) do
    Enum.map(strings_a, fn a ->
